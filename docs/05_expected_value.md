...
- 세그먼트 39개의 **성사율 순위와 효율(η) 순위의 상관은 0.669**다. 부트스트랩 90% 구간(0.609~0.691)이 모두 판정 경계 0.7 아래에 있다.
...
|---|---|---|---|
| **수락 금액 × 작업시간 (주)** | **0.669** (90% 구간 0.609~0.691) | 0.454 | 0.219 |
...
- **판정 (규칙 ①):** 주 조합 ρ = 0.669 < 0.7이고, 구간 상한(0.691)도 0.7 아래다 → **"다르다"**. 네 조합 모두 0.7 미만이다.
...
| 10,000~15,500 · 신규·표식 없음 | 960 | 0.640 | 14,485 | 13,318 | 10 | 24 |
| 6,500~10,000 · 신규·표식 없음 · 기타 | 579 | 0.598 | 9,514 | 8,473 | 16 | 30 |
| 6,500 이하 · 신규·표식 없음 | 686 | 0.520 | 6,136 | 5,512 | 24 | 35 |
| 6,500~10,000 · 신규·A_Submitted · Home improvement | 1,015 | 0.570 | 9,820 | 10,024 | 18 | 28 |
| **성사율은 낮은데 효율은 높음** | | | | | | |
| 25,000 초과 · 신규·A_Submitted · 용도 불명 | 543 | 0.442 | 39,184 | 26,240 | 34 | 9 |
| 25,000 초과 · 신규·A_Submitted · Home improvement | 755 | 0.473 | 37,463 | 25,921 | 31 | 10 |
| 25,000 초과 · 신규·A_Submitted · Car | 336 | 0.497 | 32,334 | 21,885 | 28 | 11 |
| 25,000 초과 · 신규·A_Submitted · Existing loan takeover | 1,003 | 0.553 | 40,001 | 28,711 | 20 | 8 |
| 15,500~25,000 · 신규·A_Submitted · 용도 불명 | 477 | 0.497 | 21,776 | 16,796 | 29 | 19 |

- 성사율은 높지만 효율이 낮은 쪽은 **소액·중액**이다. 신규·표식 없음이나 한도 증액처럼 성사가 잘 되는 경로라도, 대출 규모가 작으면 공수 대비 효율이 낮다.
- 성사율은 낮지만 효율이 높은 쪽은 **25,000유로 초과의 신규·A_Submitted**다. 두 건 중 한 건 이상이 성사되지 않지만, 성사되면 규모가 크다.
...
첫 세그먼트가 음수로 돌아서는 지점은 c/m = 4,374(6,500 이하 · 신규·A_Submitted · 용도 불명)다.
...
|---|---|---|
| 6,500 이하 · 신규·A_Submitted · Car | 724 | **7.95%** (최고) |
| 6,500 이하 · 신규·A_Submitted · 용도 불명 | 778 | 7.40% |
| 6,500 이하 · 신규·A_Submitted · Existing loan takeover | 872 | 6.60% |
| … | | |
| 0(미기재) · 한도 증액 · 용도 불명 | 7,381 | 0.78% |
