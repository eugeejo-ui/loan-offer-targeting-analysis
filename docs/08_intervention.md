...
| 고객 보유 비중 범위 | 73.2%(25,000 초과 · 한도 증액) ~ 89.4%(6,500~10,000 · 신규·표식 없음 · Car) |
| 은행 보유 일수 중앙값 범위 | 0.93일(6,500~10,000 · 신규·표식 없음 · Car) ~ 5.18일(25,000 초과 · 신규·A_Submitted · Existing loan takeover) |
...
- **접수 경로에 따라 은행 보유 기간이 다르다.** 신규·표식 없음 세그먼트는 은행 보유 일수가 짧다(0.9~3.1일). 신규·A_Submitted는 길다(2.4~5.2일). A_Submitted의 의미를 알 수 없으므로(Phase 1) 원인은 해석하지 않는다.
